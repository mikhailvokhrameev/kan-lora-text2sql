...
отсортированными по имени. Порядок зафиксирован намеренно: по нему в
задаче 15 (мера выученной нелинейности) будет собираться построчная
диагностика сплайнов, и строки таблицы обязаны совпадать между разными
прогонами одной и той же модели.
