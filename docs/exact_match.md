...
Мера выученной нелинейности, сборка конфигурации и карточки результата
прогона, замер задержки генерации со слиянием адаптера и без — задачи 15–17
плана, ещё не сделаны. Execution Accuracy реализована отдельно —
см. [`execution.md`](execution.md).
