...
сборки карточки результата (Задача 16 плана, ещё не реализована).

## Не реализовано

Мера выученной нелинейности, сборка конфигурации и карточки результата
прогона, замер задержки генерации со слиянием адаптера и без — задачи
15–17 плана, ещё не сделаны.
